...
public struct KeyboardShortcutReference: Hashable, Sendable {
    ...
    public static let defaults: [Self] = [
        ...
        Self(keys: "⌘D", action: "Describe the selected object in a new window"),
        ...
        Self(keys: "⌘Y", action: "Open selected object YAML in a new window"),
        Self(keys: "E", action: "Open YAML in a new window and start editing"),
