...
@Test func selectionCardinalityValidatesCommands() {
    ...
    #expect(CommandValidator.isEnabled(.editLabels, in: one))
    #expect(CommandValidator.isEnabled(.editAnnotations, in: one))
    #expect(CommandValidator.isEnabled(.editLabels, in: many) == false)
    #expect(CommandValidator.isEnabled(.editAnnotations, in: many) == false)
