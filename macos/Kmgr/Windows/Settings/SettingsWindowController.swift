    ...
    NSTextFieldDelegate
{
    ...
    private let logRecordLimitField = TechnicalTextField()
    private let logByteLimitField = TechnicalTextField()
    private let renderBatchField = TechnicalTextField()
    private let maximumRenderedLogTextField = TechnicalTextField()
    private let maximumDisplayedLogLineField = TechnicalTextField()
    private let completedOperationHistoryLimitField = TechnicalTextField()
    ...
    private let projectionWorkerLimitField = TechnicalTextField()
    private let globalWarmViewLimitField = TechnicalTextField()
    private let globalWarmObjectLimitField = TechnicalTextField()
    private let globalWarmMemoryPercentField = TechnicalTextField()
    private let authorityWarmViewLimitField = TechnicalTextField()
    private let authorityWarmObjectLimitField = TechnicalTextField()
    private let authorityWarmMemoryPercentField = TechnicalTextField()
    private let kubernetesQPSField = TechnicalTextField()
    private let kubernetesBurstField = TechnicalTextField()
    private let kubernetesListPageSizeField = TechnicalTextField()
    private let clusterConnectionTimeoutField = TechnicalTextField()
    private let kubernetesRequestTimeoutField = TechnicalTextField()
    private let idleMetricProviderLimitField = TechnicalTextField()
    private let idleMetricSampleLimitField = TechnicalTextField()
    private let exactPodMetricsEntryLimitField = TechnicalTextField()
    private let exactPodMetricsSampleLimitField = TechnicalTextField()
    private let exactPodMetricsDetailEntryLimitField = TechnicalTextField()
    private let exactPodMetricsGETConcurrencyField = TechnicalTextField()
    private let logQueueRecordLimitField = TechnicalTextField()
    private let logQueueByteLimitField = TechnicalTextField()
    private let logSourceOpenConcurrencyField = TechnicalTextField()
    ...
    private let columnsPathField = TechnicalTextField()
